...
body { background: #dceaff url(/~site/images/project/home/project_lis_background_gradient_1x856.gif) repeat-x; }
#shadow-wrapper
{
width: 970px;
margin: 0px auto;
...
width: 10px;
height: 711px;
background: #dceaff url(/~site/images/project/home/project_lis_background_left_shadow_10x711.gif) no-repeat;
}
#right-shadow
{
position: absolute;
...
width: 10px;
height: 711px;
background: #dceaff url(/~site/images/project/home/project_lis_background_right_shadow_10x711.gif) no-repeat;
}
#main-wrapper
{
position: relative;
...
#content-main { float: left; margin-left: 18px; width: 700px; display: inline; }
.content-left-col { float: left; width: 430px; }
.content-right-col { float:right; margin-right: 20px; display: inline; width: 230px; }
#footer { position: relative; z-index: 1; margin: -45px auto 0px; width: 950px; } 
.footer-content { color: #787878; height: 40px; text-align: center; padding-top: 4px; border-top: 1px solid #2f5ebf; font-size: 11px; line-height: 18px; }
.footer-content a { color: #1a4d8d; }
.footer_divider { color: #b8b8b8; font-size: 11px; }
#content-navigation * { font-size: 13px; font-family: Trebuchet MS, Lucida Sans, sans-serif; color: #333333; line-height: 17px; }
#content-navigation { float: left; position: relative; width: 222px; min-height: 631px; _height: 631px; background: url(/~site/images/project/home/project_nav_background_middle_210x1.gif) repeat-y; } 
#content-navigation .nav-top-gradient { position: absolute; top: 0px; left: 0px; width: 210px; height: 172px; background: url(/~site/images/project/home/project_nav_background_top_210x198.gif) no-repeat; }
#content-navigation .nav-bottom-gradient { position: absolute; bottom: 0px; left: 0px; width: 210px; height: 459px; background: url(/~site/images/project/home/project_nav_background_bottom_210x459.gif) no-repeat; }
#nav-container { position: relative; padding-top: 13px; z-index: 1; _height: 0; } 
#nav-container ul, #nav-container li { margin: 0px; padding: 0px; }
#nav-container li { list-style: none; zoom: 1; } 
#nav-container a { display: block; position: relative; width: 210px; zoom: 1; } 
#nav-container a:hover { text-decoration: none; }
#nav-container .secondary-nav-selected .secondary-anchor, #nav-container .tertiary-nav-selected a { width: auto; }
#nav-container .tertiary-nav-selected a:hover { background-color: transparent; }
#nav-container span { display: block; }
#nav-container span.secondary-label { padding: 12px 0px 12px 24px; }
#nav-container span.tertiary-label { padding: 12px 0px 12px 65px; }
#nav-container .secondary-icon, #nav-container .tertiary-icon { position: absolute; }
#nav-container #Services-nav span.secondary-label { display: none; }
#nav-container #GettingStarted-nav.secondary-nav-selected span.secondary-label { padding-bottom: 11px; } 
#nav-container #ExploreServices-nav ul * { font-size: 12px; }
#nav-container #ExploreServices-nav span.tertiary-label { background: none; padding: 4px 0px 4px 24px; }
#nav-container a:hover, .secondary-nav-selected .secondary-anchor, .tertiary-nav-selected a, #Services-nav .tertiary-icon { background-repeat: no-repeat; background-image: url(/~site/images/project/home/project_nav_sprites_279x155.gif); }
.secondary-anchor:hover, .tertiary-nav a:hover { background-position: -1px -48px; }
.secondary-nav-selected .secondary-anchor, .secondary-nav-selected .secondary-anchor:hover, .tertiary-nav-selected a, .tertiary-nav-selected a:hover { font-weight: bold; background-position: -1px -89px; }
#ExploreServices-nav .tertiary-nav-selected a, #ExploreServices-nav .tertiary-nav a:hover { background-position: -1px -130px; }
#nav-container #IWantTo-nav ul * {font-size: 12px; }
#nav-container #IWantTo-nav span.tertiary-label {background: none; padding: 4px 0px 4px 24px; }
#nav-container #GettingStarted-nav, #nav-container #ExploreServices-nav, #nav-container #IWantTo-nav { background: url(/~site/images/project/home/project_nav_divider_190x1.gif) 10px 0px no-repeat; padding-top: 1px; }
#IWantTo-nav .tertiary-nav-selected a, #IWantTo-nav .tertiary-nav a:hover { background-position: -1px -130px; }
#Services-nav .tertiary-icon { width: 31px; height: 24px; top: 8px; left: 24px; }
#Websites-nav .icon { background-position: 0px 0px; }
#Websites_rec-nav .icon { background-position: 0px -24px; }
#Domains-nav .icon { background-position: -31px 0px; }
#Domains_rec-nav .icon { background-position: -31px -24px; }
#EmailServices-nav .icon { background-position: -62px 0px; }
#EmailServices_rec-nav .icon { background-position: -62px -24px; }
#Ecommerce-nav .icon { background-position: -279px 0px; top: 12px;}
#Directory-nav .icon { background-position: -93px 0px; }
#WebListings-nav .icon { background-position: -124px 0px; }
#WebListings_rec-nav .icon { background-position: -124px -24px; }
#WebListings_rec_new-nav .icon { background-position: -124px -24px; }
#DesignServices-nav .icon { background-position: -155px 0px; }
#DesignServices_rec-nav .icon { background-position: -155px -24px; }
#EmailMarketing-nav .icon { background-position: -186px 0px; }
#EmailMarketing_rec-nav .icon { background-position: -186px -24px; }
#HowTrafficWorks-nav .icon { background-position: -217px 0px; }
#SearchLight_rec-nav .icon { background-position: -217px -24px; }
#SearchLight_rec_new-nav .icon { background-position: -217px -24px; }
#Storefront-nav .icon	{ background-position: -248px 0px; }
.bold{
font-weight: bold;
}
.lis_header
...
.lis_header_bar_iws
{
background: url('/~site/images/project/home/project_header_background_952x74.gif') no-repeat;
...
border-bottom: 3px solid #1e4994;
height: 72px;
}
.lis_header_bar_vz
{
...
.lis_header_bar_vz .lis_header_actions
{
float: none;
margin: 0 auto;
line-height: 27px;
width: 296px;
background: url('/~site/images/project/home/project_header_action_links_background_1x27.jpg') repeat-x;
position: relative;
}
.lis_header *
{
...
.lis_header_bar_vz .lis_header_actions_bg_left
{
position: absolute;
left: 0px;
top: 0px;
height: 27px;
width: 5px;
background: url('/~site/images/project/home/project_header_action_links_left_5x27.jpg') no-repeat;
}
.lis_header_bar_vz .lis_header_actions_bg_right
{
position: absolute;
right: 0px;
top: 0px;
height: 27px;
width: 6px;
background: url('/~site/images/project/home/project_header_action_links_right_6x27.jpg') no-repeat;
}
.lis_header_bar_iws .lis_header_action
{
border-right-color: #4295db;
}
.lis_header_bar_hs .lis_header_action
{
border-right-color: #cccccc;
}
.lis_header_bar_vz .lis_header_action
{
...
.lis_header_action_last
{
border-right: none;
padding-right: 0px;
margin-right: 16px;
}
.lis_header_bar_vz .lis_header_action_last
{
padding: 0px 12px;
margin-right: 0px;
}
.lis_header_left_logo
{
float: left;
display: inline;
}
.lis_header_bar_iws .lis_header_left_logo
{
margin: 25px 0px 0px 23px;
}
.lis_header_bar_hs .lis_header_left_logo
{
margin: 17px 0px 0px 15px;
}
.lis_header_bar_vz .lis_header_left_logo
{
margin: 22px 0px 0px 20px;
}
.lis_header_right_logo
{
float: right;
display: inline;
}
.lis_header_bar_iws .lis_header_right_logo
{
margin: 9px 16px 0px 7px;
}
.lis_header_bar_vz .lis_header_right_logo
{
margin: 12px 29px 0px 0px;
}
.lis_header_bar_vz .lis_header_bottom
{
position: absolute;
bottom: 0px;
left: 0px;
...
line-height: 8px;
width: 100%;
background: url(/~site/images/project/home/project_header_border_bottom_1x7.jpg) repeat-x;
}
.lis_header_content_header
{
float: right;
position: relative;
width: 710px;
...
/* takes place of header greeting when on logged out page */
.los_header_content_header
{
float: right;
height: 30px;
width: 710px;
...
.lis_header_help_chat_tooltip
{
background: url('/~site/images/project/home/project_chat_tooltip_big_224x53.png') no-repeat;
position: absolute;
top: 47px;
right: 0px;
z-index: 2;
...
.lis_header_help_call_tooltip
{
background: url('/~site/images/project/home/project_chat_tooltip_sml_144x37.png') no-repeat;
position: absolute;
top: 47px;
right: 0px;
z-index: 2;
...
.lis_header_help
{
background: url('/~site/images/project/home/project_header_help_background_1x42.gif') repeat-x;
position: absolute;
top: 13px;
right: 0px;
z-index: 1;
...
.lis_header_help_left
{
background: url('/~site/images/project/home/project_header_help_background_left_8x42.gif') no-repeat;
width: 8px;
height: 42px;
float: left;
}
.lis_header_help_right
{
background: url('/~site/images/project/home/project_header_help_background_right_4x42.gif') no-repeat;
width: 4px;
height: 42px;
float: right;
}
.lis_header_help_links
{
font-size: 11px;
margin-top: 12px;
margin-left: 6px;
...
#lis_header_help_chat_id
{
display: none;
}
#lis_header_chat_divider
{
display: none;
}
#lis_header_help_call_id
{
display: none;
}
.lis_header_help_call a:hover
{
text-decoration: none;
}
.lis_header_help_phone
{
font-weight: bold;
white-space: nowrap;
}
...
.lis_header_bar_iws #lis_header_csr_partner_id
{
color: #ffffff;
}
.lis_header_bar_hs #lis_header_csr_partner_id
{
color: #8c0424;
}
#lis_header_csr_name_id
{
color: #000000;
}

body { background-image: url(/defaultUser/EmergencyImages/project_lis_background_gradient_1x856.gif); }
#left-shadow { background-image: url(/defaultUser/EmergencyImages/project_lis_background_left_shadow_10x711.gif); }
#right-shadow { background-image: url(/defaultUser/EmergencyImages/project_lis_background_right_shadow_10x711.gif); }
#content-navigation { background-image: url(/defaultUser/EmergencyImages/project_nav_background_middle_210x1.gif); }
#content-navigation .nav-top-gradient { background-image: url(/defaultUser/EmergencyImages/project_nav_background_top_210x198.gif); }
#content-navigation .nav-bottom-gradient { background-image: url(/defaultUser/EmergencyImages/project_nav_background_bottom_210x459.gif); }
...
<div id="main-wrapper">
<div class="lis_header">
<div class="lis_header_bar_hs">

<div class="lis_header_left_logo">
<a id="lis_header_left_logo_id" href="/"><img src="/defaultUser/emergencyImages/hslogo_site_found_customers_175x40.gif" width="175" height="40" alt="Homestead" border="0" /></a>
</div>
...
<div class="nav-top-gradient"></div>
<div class="nav-bottom-gradient"></div>
</div>
<div id="content-main">
<div class="los_header_content_header"></div>

<div class="PT20-div">
<h1 class="PT20">Sorry, the page you're looking for can't be found.</h1>
</div>
<p>Please try one of these links:</p>
<div class="bullet_links">
<ul>
<li><a href="http://www.homestead.com/" class="bullet_text">Home Page</a></li>
<li><a href="http://www.homestead.com/~site/hslo/website/howitworks.ffhtml" class="bullet_text">How It Works</a></li>
<li><a href="http://www.homestead.com/~site/hslo/website/tour.ffhtml" class="bullet_text">Quick Tour</a></li>
<li><a href="http://www.homestead.com/~site/hslo/website/features.ffhtml" class="bullet_text">Features</a></li>
<li><a href="http://www.homestead.com/~site/hslo/website/gallery.ffhtml" class="bullet_text">Design Gallery</a></li>
<li><a href="http://www.homestead.com/~site/hslo/website/customersites.ffhtml" class="bullet_text">Customer Sites</a></li>
<li><a href="http://www.homestead.com/~site/go/start.ffhtml?SPTID=LoWebsiteTour_TryButton_Nav&TARGET=/~site/Signup/TrialSignup.ffhtml" class="bullet_text">Free Trial</a></li>
</ul>
</div>
...
<a href="http://www.homestead.com/~site/Help/help_page.ffhtml" onclick="s_objectID='helpcenter_footerlink';" rel="nofollow">Help Center</a> <span class='footer_divider'>|</span> <a href="http://directory.homestead.com" target="_blank">Directory</a> <span class='footer_divider'>|</span> <a href="http://www.homestead.com/~site/Legal/terms_of_service.ffhtml" rel="nofollow" onclick="s_objectID='tos_footerlink';">Terms Of Service</a> <span class='footer_divider'>|</span> <a href="http://www.homestead.com/~site/Legal/privacy.ffhtml" rel="nofollow" onclick="s_objectID='privacy_footerlink';">Privacy</a> <span class='footer_divider'>|</span> <a href="http://www.homestead.com/affiliates/" target="_blank" rel="nofollow" onclick="s_objectID='affiliates_footerlink';">Affiliates Program</a> <span class='footer_divider'>|</span> <a href="http://www.intuitcareers.com/home/" rel="nofollow" onclick="s_objectID='careers_footerlink';">Careers</a> <span class='footer_divider'>|</span> <a href="http://www.homestead.com/~site/hslo/about/abouthomestead.ffhtml" rel="nofollow" onclick="s_objectID='aboutus_footerlink';">About Us</a>
<br />
&copy; 2010 Homestead Technologies Inc. All Rights Reserved.
</div>
</div>
...
<script language="JavaScript" src="/~site/javascript/sc_v1/s_code.ffhtml"></script>
<script language="JavaScript" src="/~site/javascript/sc_v1/s_code.js"></script>
<script language="JavaScript" src="/~site/javascript/sc_v1/omniture_utils.js"></script>
<script language="JavaScript"><!--
try
{	
/* You may give each page an identifying name, server, and channel on
the next lines. */
var bIsSite = isSiteHostname(window.location.hostname);
var section = bIsSite ? "Site Error Pages" : "User Error Pages";
s.pageName= (bIsSite ? "Site" : "User") + " Site[+]404 Error";
...
<noscript>
<a href="http://www.omniture.com" title="Web Analytics"><img src="https://homesteadtechnologies.122.2o7.net/b/ss/ht-homesteadcom1/1/H.14--NS/0" height="1" width="1" border="0" alt="" /></a>
...
<script language="JavaScript" src="/~site/javascript/sc_v1/s_code_intuit.js"></script>
<script language="JavaScript" type="text/javascript"><!--
try
{	
/* You may give each page an identifying name, server, and channel on
the next lines. */
s2.pageName="wsba|"+ section +" Error Pages|" + s.pageName + "|engage"
s2.server=window.location.hostname
s2.channel=section;
s.pageType=""; 
s2.prop1="sbe"
s2.prop2="wbsa"
s2.prop3="wbsa|"+section
s2.prop4="wbsa|"+section+"|engage"
s2.prop5="" // Global Nav Clicks (N/A)
s2.prop6="" // Free
s2.prop7="" // Free
s2.prop8="" // Free
s2.prop9="" // Merchandising Categories (TBD)
s2.prop11="" // Free
s2.prop15="" // Free
s2.evar16="" // Visit Intent (shopper or SaaS)
s2.prop17="" // Referring URLs All
s2.prop18="" // Referring Domains All
s2.prop19="" // Relevant Content Segment (N/A)
...
<noscript>
<a href="http://www.omniture.com" title="Web Analytics"><img src="https://intuitinc.122.2o7.net/b/ss/intuit-websites-li-qa/1/H.20.3--NS/0" height="1" width="1" border="0" alt="" /></a>
</noscript><!--/DO NOT REMOVE/-->
